  ...
  chooseCountry(id)
{
  ...
  public addTeammembers() {
    ...
    {
      let c = this.teammemberslist.find(x=> x.UserId != this.getTeammember.UserId);
      const Cexists = this.teammemberslist.findIndex(element => element.UserId === this.getTeammember.UserId) > -1;
      if (!Cexists && this.getTeammember.FirstName!=undefined) {
        ...
        if(i.FirstName !="Invited"   && i.IsRemove!=true)
{
  ...
  SaveUser()
  {
    if(this.Addform.invalid)
    {
      ...
      this.Addform.controls['PhoneNumber'].markAsTouched()
    ...
    else if(this.result.UserId==0)
    {
      ...
      this.Addform.value.PhoneNumber = this.Ccode + this.Addform.value.PhoneNumber.toString();
        ...
        .subscribe(
        data1 => {
           this.toastr.success('Contact details added to list.','Success');
           setTimeout(() => { 
            this.Addform.reset();  
            this.selectedUserName=undefined;  
            //this.flag=false;       
