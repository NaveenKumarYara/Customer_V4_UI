...
@Component({
  selector: 'app-cmeditprofile',
  templateUrl: './editprofile-cm.component.html',
  styleUrls: ['./editprofile-cm.component.css'],
  providers: [NgxSpinnerService, AlertService]
})
export class EditprofileCmComponent implements OnInit {
  emailCheck = false;
  selectedIndex = -1;
  selectedeIndex = -1;
  selectedcIndex = -1;
...
Job = {
  ...
  ngOnInit() {
    ...
    /** */
    this.showThis = "Personal Details"
  }
