...
export class AdvanceSearchComponent implements OnInit {
  ...
  ProfileStatusList: any = [
    ...
    { Id: 2, Name: "InActive Jobs" },
    { Id: 3, Name: "Interviewing" },
    { Id: 4, Name: "Freezed Jobs" },
    { Id: 5, Name: "Closed Jobs" },
    { Id: 6, Name: "ShortListing" },
  ];
  SkillList: any = [];
  LastPostedList: any = [
    { Id: 1, Name: "Today" },
    { Id: 2, Name: "Last Week" },
    { Id: 3, Name: "Last 2 Week" },
  ...
  filters: any = {
    ...
    showlastpostedfilter: false,
    showimmigrationstatusfilter: false,
  ...
  GetEmployementType() {
    ...
    return this.appService.getEmploymentType().subscribe(
      (data) => {
  ...
  apply() {
    if (1) {
      ...
      this.SelectedClientList.forEach((element) => {
        ...
        } else clients = clients.toString() + "," + element.ClientId.toString();
      });
      ...
      this.SelectedDomainList.forEach((element) => {
        ...
        } else domain = domain.toString() + "," + element.DomainId.toString();
      });
      ...
      this.SelectedimmigrationstatusList.forEach((element) => {
        ...
        } else immigrations = immigrations.toString() + "," + element.ImmigrationStatusId.toString();
      });
      ...
      this.SelectedCategoryList.forEach((element) => {
        ...
        } else category = category.toString() + "," + element.JobCategoryId.toString();
      });
      ...
      this.selectedJobType.forEach((element) => {
        ...
        } else empType = empType.toString() + "," + element.EmploymentTypeId.toString();
      });
      ...
      this.SelectedProfileStatusList.forEach((element) => {
        ...
        } else profileStatus = profileStatus.toString() + "," + element.Id.toString();
      });
      // titles = titles.toString()+',' + element.JobTitleId.toString();
      ...
      var jobStatus;
      if (this.jobStatus != null) jobStatus = this.jobStatus;
      else {
        jobStatus = "";
      }
      ...
      var lastyear = "";
      var today = "";
      if (this.postedtype == 1) today = "1";
      else if (this.postedtype == 2) lastWeek = "1";
      else if (this.postedtype == 3) lastTwoWeek = "1";
      else if (this.postedtype == 4) last30days = "1";
      else if (this.postedtype == 5) last90days = "1";
      else if (this.postedtype == 6) lastyear = "1";

      var minExp;
      if (this.minExp >= 0 && this.minExp != "") minExp = Number(this.minExp * 12);
      else {
        this.minExp = "";
      ...
      var maxExp;
      if (this.maxExp >= 0 && this.maxExp != "") maxExp = this.maxExp * 12;
      else {
        this.maxExp = "";
      ...
      var minSal;
      if (this.minSal >= 0 && this.minSal != "") minSal = Number(this.minSal);
      else {
        this.minSal = "";
      ...
      var maxSal;
      if (this.maxSal >= 0 && this.maxSal != "") maxSal = Number(this.maxSal);
      else {
        this.maxSal = "";
      ...
      if (
        ...
        (minExp >= 0 && maxExp >= 0 && maxExp != "" && minExp != "") ||
        (minSal >= 0 && maxSal >= 0 && maxSal != "" && minSal != "") ||
        clients.length > 0 ||
        domain.length > 0 ||
  ...
  changeCategory(JobCategoryId) {
    if (this.SelectedCategoryList.length == 0)
      ...
      var index = this.SelectedCategoryList.indexOf(
        this.CategoryMainList.find((a) => a.JobCategoryId == JobCategoryId)
      );
      this.SelectedCategoryList.splice(index, 1);
    }
  }
  changeskills(Id) {
    if (this.SelectedSkillList.length == 0) this.SelectedSkillList.push(this.SkillMainList.find((a) => a.Id == Id));
  ...
  changeEducation(QualificationId) {
    if (this.SelectedEducationList.length == 0)
      ...
      var index = this.SelectedEducationList.indexOf(
        this.EducationMainList.find((a) => a.QualificationId == QualificationId)
      );
  ...
  changeImmigration(ImmigrationStatusId) {
    if (this.SelectedimmigrationstatusList.length == 0)
      this.SelectedimmigrationstatusList.push(
        this.immigrationstatusMainList.find((a) => a.ImmigrationStatusId == ImmigrationStatusId)
      );
      ...
      var index = this.SelectedimmigrationstatusList.indexOf(
        this.immigrationstatusMainList.find((a) => a.ImmigrationStatusId == ImmigrationStatusId)
      );
  ...
  GetSearchClients(cname) {
    ...
    return this.appService.SearchClients(this.cn).subscribe(
      (data) => {
        if (data.length > 0) {
  ...
  getSkills() {
    this.skilllist = concat(
      ...
      this.selectedskillinput.pipe(
        ...
        switchMap((term) =>
          this.appService.getAllSkills(term).pipe(
            catchError(() => of([])), // empty list on error
  ...
  GetSearchDepartments(dname) {
    ...
    return this.appService.SearchDepartments(this.dn).subscribe(
      (data) => {
        if (data.length > 0) {
      ...
      if (res != null) {
        ...
        if (res.titles != "") {
          ...
          Jobtitle.forEach((element) => {
            this.appService.getJobTitle(element).subscribe((data) => {
        ...
        if (res.JobStatus != "") {
          ...
          jobstat.map((element) =>
            this.SelectedProfileStatusList.push(this.ProfileStatusMainList.find((a) => a.Id == element))
          );
        ...
        if (res.users != "") {
          ...
          this.appService.getCustomerContacts(this.customerId).subscribe((data) => {
            this.UsersList = data;
        ...
        if (res.empType != "") {
          ...
          this.appService.getEmploymentType().subscribe((data) => {
            this.employmentMainList = data;
            this.employmentList.next(this.employmentMainList);
            empType.map((element) =>
              this.selectedJobType.push(this.employmentMainList.find((a) => a.EmploymentTypeId == Number(element)))
            );
  ...
  getAllCity(s) {
    return this.appService.getCities(s).subscribe(
      (data) => {
        this.cities = data;
      },
      (error) => {}
  ...
  GetCity(val) {
    return this.managejobservice.GetSearch(val).subscribe(
      (data) => {
        if (data.length > 0) {
  ...
  filterEmpType() {
    ...
    // filter the banks
    this.employmentList.next(
      this.employmentMainList.filter((b) => b.EmploymentType.toLowerCase().indexOf(search) > -1)
    );
  }
  ...
  protected filterBanksMulti() {
    ...
    this.appService.getCities(search).subscribe((data) => {
      ...
      // filter the banks
      this.filteredBanksMulti.next(this.banks.filter((bank) => bank.CityName.toLowerCase().indexOf(search) > -1));
    });
  }
  ...
  protected filterJobCategory() {
    ...
    this.appService.searchJobCategory(search).subscribe((data) => {
      // this.Category =data;
  ...
  protected filterskills() {
    ...
    this.appService
      ...
      .subscribe((data) => {
        ...
        // filter the banks
        this.filteredSkillList.next(this.Skill.filter((Skill) => Skill.Code.toLowerCase().indexOf(search) > -1));
      });
  }
  protected filterClient() {
    ...
    this.cn.IsSuggested = false;
    this.appService.SearchClients(this.cn).subscribe((data) => {
      // this.Category =data;
  ...
  protected filterDepartment() {
    ...
    this.appService.searchDepartment(search, false, this.customerId).subscribe((data) => {
  ...
  protected filterUsers() {
    ...
    this.filteredUsersList.next(this.User.filter((User) => User.FirstName.toLowerCase().indexOf(search) > -1));
    // });
  }
  ...
  getAllSkills() {
    this.appService.getAllSkills("a").subscribe(
      (data) => {
        this.SkillList = data;
        this.SkillMainList = data;
        ...
        // listen for search field value changes
        this.SkillsFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
          this.filterskills();
        });
      },
      (error) => {}
  ...
  GetImmigrationStatus() {
    this.appService.GetImmigrationStatus().subscribe(
      (res) => {
        ...
        this.immigrationstatusFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
  ...
  GetJobCategory() {
    this.appService.searchJobCategory("a").subscribe(
      (data) => {
        ...
        this.CategoryFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
  ...
  getAllJobTitle() {
    this.appService.getJobTitle("a").subscribe(
      (data) => {
        ...
        // listen for search field value changes
        this.JobtitleFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
          this.filterJobTitle();
        });
      },
      (error) => {}
  ...
  getQualificationDetails() {
    this.appService.getQualificationDetails().subscribe(
      (data) => {
        ...
        this.EducationFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
  ...
  getAllUsers() {
    this.appService.getCustomerContacts(this.customerId).subscribe(
      (data) => {
        this.UsersList = data;
        this.UsersMainList = data;
        this.UsersList = this.UsersList.filter((name) => name.FirstName != "Invited");
        this.UsersMainList = this.UsersMainList.filter((name) => name.FirstName != "Invited");
        console.log(this.UsersList, "UsersList");
        // this.Education.setValue([this.EducationList[0]]);
        this.filteredUsersList.next(this.UsersList.slice());
        this.UsersFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
          this.filterUsers();
        });
      },
      (error) => {}
  ...
  getDomainDetails() {
    this.appService.getDomainDetails().subscribe(
      (data) => {
        ...
        this.DomainFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
          this.filterDomain();
        });
      },
      (error) => {}
  ...
  getAllDepartments() {
    this.appService.searchDepartment("a", false, this.customerId).subscribe(
      (data) => {
        ...
        this.DepartmentFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
  ...
  getAllClients() {
    ...
    this.cn.IsSuggested = false;
    this.appService.SearchClients(this.cn).subscribe(
      (data) => {
        ...
        this.ClientFilter.valueChanges.pipe(takeUntil(this._onDestroy)).subscribe(() => {
          this.filterClient();
        });
      },
      (error) => {}
  ...
  RemoveComponent(componentNo) {
    if (componentNo == 1) {
      ...
      this.filters.showClient = false;
      this.Client = new FormControl();
      this.SelectedClientList = [];
      this.filteredClientList.next(this.ClientList.slice());
    } else if (componentNo == 6) {
      this.filters.showDepartment = false;
      this.Department = new FormControl();
      this.SelectedDepartmentList = [];
      this.filteredDepartmentList.next(this.DepartmentList.slice());
    } else if (componentNo == 7) {
      this.filters.showskillsfilter = false;
      this.Skills = new FormControl();
      this.SelectedSkillList = [];
      this.filteredSkillList.next(this.SkillList.slice());
    } else if (componentNo == 8) {
      this.filters.showlastpostedfilter = false;
      this.LastPosted = new FormControl();
      this.SelectedLastPostedList = [];
      this.filteredLastPostedList.next(this.LastPostedList.slice());
    } else if (componentNo == 9) {
      this.filters.showimmigrationstatusfilter = false;
      this.immigrationstatus = new FormControl();
      this.SelectedimmigrationstatusList = [];
      this.filteredimmigrationstatus.next(this.immigrationstatusList.slice());
    } else if (componentNo == 10) {
      this.filters.showExperience = false;
      this.minExp = "";
      this.minExp = this.minExp.toString();
      this.maxExp = this.minExp.toString();
    } else if (componentNo == 11) {
      this.filters.showSalaryrange = false;
      this.minSal = "";
      this.minSal = this.minSal.toString();
      this.maxSal = this.minSal.toString();
    } else if (componentNo == 12) {
      this.filters.showCategory = false;
      this.Category = new FormControl();
      this.SelectedCategoryList = [];
      this.filteredCategoryList.next(this.CategoryList.slice());
    } else if (componentNo == 13) {
      this.filters.showDomain = false;
      this.Domain = new FormControl();
      this.SelectedDomainList = [];
      this.filteredDomainList.next(this.DomainList.slice());
    } else if (componentNo == 14) {
      this.filters.showEducation = false;
      this.Education = new FormControl();
      this.SelectedEducationList = [];
      this.filteredEducation.next(this.EducationList.slice());
    } else if (componentNo == 15) {
      this.filters.showusers = false;
      this.Users = new FormControl();
      this.SelectedUsersList = [];
      this.filteredUsersList.next(this.UsersList.slice());
    }
