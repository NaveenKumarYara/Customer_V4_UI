import { Component, OnInit, ViewContainerRef, Input, ViewChild, Output, EventEmitter, ElementRef, OnDestroy } from "@angular/core";
import { ActivatedRoute, Params, Router } from "@angular/router";
import { JobdetailsService } from "../../jobdetails/jobdetails.service";
import { AppService } from "../../../app.service";
import { MatDialog, MatDialogRef, MAT_DIALOG_DATA } from "@angular/material";
import { JobdetailsProfile, MatchingParameterDetails } from "../../jobdetails/models/jobdetailsprofile";
...
import { UniqueMonthYearPipe } from "./../../jobdetails/view-jobdetails/months.pipe";
...
import { mappingdetails } from "../../jobdetails/view-jobdetails/viewjobdetails-candidate-profile/view-candidateprofile/mappingdetails";
...
@Component({
  ...
  templateUrl: './candidatedetailview.component.html',
  styleUrls: ['./candidatedetailview.component.css'],
  providers: [NgxSpinnerService, AlertService, ApiService],
})
export class CandidatedetailviewComponent implements OnInit, OnDestroy {
  customer: any;
  customerId: any;
  cultureresults: any = [];
  userId: any;
  ...
  constructor(private toastr: ToastsManager, private _vcr: ViewContainerRef,private route: ActivatedRoute,
    ...
    this.route.params.subscribe(params => {
        ...
        if (params["Preid"] != null) {
          localStorage.setItem("cdprofileId", params["Preid"]);
          localStorage.setItem("customerId",params["Cid"]);
  ...
  populateCompanyProfile() {
    return this.jobdetailsservice.getCompanyProfile(this.customerId).subscribe(res => {
  ...
  GetCandidateJobHistory() {
    this._service.GetService("ProfileAPI/api/GetCandidateDetailHistrory?profileId=", this.profileId + '&customerId=' + this.customerId).subscribe((info) => {
  ...
  ngOnDestroy() {
    localStorage.removeItem('cdprofileId');
